...
@Component
public class UpdateAuthorDataFetcher implements DataFetcher<Author> {
    ...
    public Author get(DataFetchingEnvironment dataFetchingEnvironment) {
        ...
        authorRepository.getOne(id).setFirstName(firstName);
        authorRepository.getOne(id).setLastName(lastName);
